...
<body>
	<form class="form-inline dropdown">
		<div class="form-group">
			...
			<input type="text" class="form-control dropdown-toggle" placeholder="Search customer company name/ticker" data-toggle="dropdown">
			<ul class="nav nav-tabs dropdown-menu">
				<li class="active"><a data-toggle="tab" href="#type1">Type1</a></li>
				<li><a data-toggle="tab" href="#type2">Type2</a></li>
	...
	<div id="news">
		<div class="header">
			...
			<button class="btn btn-default">+ News Subjects</button>
		</div>
		<div class="content">
		</div>
	</div>
...
<script>
	$(document).ready(function(){
		...
		$(".nav-tabs li").not().on("click", function() {
		});
	});
</script>